...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "T-Bar Ceiling Installation in Saskatoon, SK | Dil Chahal Construction Ltd.",
  ...
  twitter: {
    ...
    title: "T-Bar Ceiling Saskatoon, SK | Dil Chahal Construction",
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  "@id": `${CANONICAL}#page`,
  name: "T-Bar Ceiling Installation in Saskatoon, SK | Dil Chahal Construction Ltd.",
...
const data: ServiceLandingData = {
  ...
  imageAlt: "Professional T-bar suspended ceiling installation for a commercial office space in Saskatoon, SK by Dil Chahal Construction",
  serviceJsonLd,
  faqJsonLd,
  breadcrumbJsonLd,
  webPageJsonLd,
