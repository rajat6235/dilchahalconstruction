...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Drywall Finishing in Saskatoon, SK | Level 1–5 | Dil Chahal Constructions",
    ...
    url: CANONICAL,
    images: [{ url: "/images/mudding.jpeg", width: 1200, height: 630, alt: "Professional drywall finishing and mudding in Saskatoon, SK by Dil Chahal Constructions" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Drywall Finishing Saskatoon, SK | Dil Chahal Constructions",
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  "@id": `${CANONICAL}#page`,
  name: "Drywall Finishing in Saskatoon, SK | Dil Chahal Constructions Ltd.",
...
const data: ServiceLandingData = {
  ...
  imageAlt: "Professional drywall finishing and compound application in a Saskatoon residential project by Dil Chahal Constructions",
  serviceJsonLd,
  faqJsonLd,
  breadcrumbJsonLd,
  webPageJsonLd,
