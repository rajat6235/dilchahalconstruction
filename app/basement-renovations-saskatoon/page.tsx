...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Basement Renovations in Saskatoon, SK | Dil Chahal Constructions Ltd.",
    ...
    url: CANONICAL,
    images: [{ url: "/images/reno2.jpeg", width: 1200, height: 630, alt: "Basement renovation and finishing project in Saskatoon, SK by Dil Chahal Constructions" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Basement Renovations Saskatoon, SK | Dil Chahal Constructions",
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  "@id": `${CANONICAL}#page`,
  name: "Basement Renovations in Saskatoon, SK | Dil Chahal Constructions Ltd.",
...
const data: ServiceLandingData = {
  ...
  intro: [
    "An unfinished basement represents hundreds of square feet of untapped living space — space that can become a family room, home office, guest suite, or legal secondary suite. Dil Chahal Constructions delivers complete basement renovation and development services throughout Saskatoon, SK, transforming cold, unfinished concrete spaces into warm, functional, and beautifully finished rooms that add real value to your home.",
