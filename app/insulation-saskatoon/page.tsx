...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Insulation Contractor in Saskatoon, SK | Dil Chahal Constructions Ltd.",
    ...
    url: CANONICAL,
    images: [{ url: "/images/insulation.jpeg", width: 1200, height: 630, alt: "Insulation installation service in Saskatoon, SK by Dil Chahal Constructions" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Insulation Contractor Saskatoon, SK | Dil Chahal Constructions",
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  "@id": `${CANONICAL}#page`,
  name: "Insulation Installation in Saskatoon, SK | Dil Chahal Constructions Ltd.",
...
const data: ServiceLandingData = {
  ...
  imageAlt: "Energy-efficient insulation installation in a residential property in Saskatoon, SK by Dil Chahal Constructions",
  serviceJsonLd,
  faqJsonLd,
  breadcrumbJsonLd,
  webPageJsonLd,
