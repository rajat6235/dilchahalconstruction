...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "GlassRoc Sheathing Installation in Saskatoon, SK | Dil Chahal Constructions Ltd.",
  ...
  twitter: {
    ...
    title: "GlassRoc Sheathing Saskatoon, SK | Dil Chahal Constructions",
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  "@id": `${CANONICAL}#page`,
  name: "GlassRoc Sheathing Installation in Saskatoon, SK | Dil Chahal Constructions Ltd.",
