...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Mudding & Taping in Saskatoon, SK | Dil Chahal Construction Ltd.",
    ...
    url: CANONICAL,
    images: [{ url: "/images/work9.jpeg", width: 1200, height: 630, alt: "Drywall mudding and taping work in Saskatoon, SK by Dil Chahal Construction" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Mudding & Taping Saskatoon, SK | Dil Chahal Construction",
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  "@id": `${CANONICAL}#page`,
  name: "Mudding & Taping in Saskatoon, SK | Dil Chahal Construction Ltd.",
...
const data: ServiceLandingData = {
  ...
  intro: [
    "Mudding and taping is where a drywall installation transforms from raw panels into a smooth, continuous surface — and it requires both skill and patience. Dil Chahal Construction provides expert mudding and taping services throughout Saskatoon, SK, delivering seamless drywall joints that are invisible after painting. Whether we're completing the finishing phase after our own installation or picking up where another contractor left off, our results are consistent: flat, smooth, and paint-ready.",
