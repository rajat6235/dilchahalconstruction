...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Wall & Ceiling Texturing in Saskatoon, SK | Dil Chahal Constructions Ltd.",
    ...
    url: CANONICAL,
    images: [{ url: "/images/texture.jpeg", width: 1200, height: 630, alt: "Professional wall and ceiling texturing in Saskatoon, SK by Dil Chahal Constructions" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Texturing Saskatoon, SK | Dil Chahal Constructions",
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  "@id": `${CANONICAL}#page`,
  name: "Wall & Ceiling Texturing in Saskatoon, SK | Dil Chahal Constructions Ltd.",
...
const data: ServiceLandingData = {
  ...
  imageAlt: "Professional wall and ceiling texturing applied by Dil Chahal Constructions in a Saskatoon residential space",
  serviceJsonLd,
  faqJsonLd,
  breadcrumbJsonLd,
  webPageJsonLd,
