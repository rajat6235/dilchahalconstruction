...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Steel Framing Contractor in Saskatoon, SK | Dil Chahal Construction Ltd.",
    ...
    url: CANONICAL,
    images: [{ url: "/images/steel-frame.jpeg", width: 1200, height: 630, alt: "Steel stud framing installation in Saskatoon, SK by Dil Chahal Construction" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Steel Framing Saskatoon, SK | Dil Chahal Construction",
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  "@id": `${CANONICAL}#page`,
  name: "Steel Framing in Saskatoon, SK | Dil Chahal Construction Ltd.",
...
const data: ServiceLandingData = {
  ...
  imageAlt: "Steel stud framing installation for commercial interior construction in Saskatoon, SK by Dil Chahal Construction",
  serviceJsonLd,
  faqJsonLd,
  breadcrumbJsonLd,
  webPageJsonLd,
