...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Bulkhead Ceiling Installation in Saskatoon, SK | Dil Chahal Constructions Ltd.",
    ...
    url: CANONICAL,
    images: [{ url: "/images/bulkhead.jpeg", width: 1200, height: 630, alt: "Custom bulkhead ceiling installation in a Saskatoon, SK residential space by Dil Chahal Constructions" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Bulkhead Ceiling Saskatoon, SK | Dil Chahal Constructions",
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  "@id": `${CANONICAL}#page`,
  name: "Bulkhead Ceiling Installation in Saskatoon, SK | Dil Chahal Constructions Ltd.",
...
const data: ServiceLandingData = {
  ...
  intro: [
    "Bulkhead ceilings — also called dropped soffits — are architectural ceiling details that add definition, conceal unsightly mechanical runs, and create zones within open-plan spaces. Dil Chahal Constructions designs and builds custom bulkhead ceilings throughout Saskatoon, SK, for both residential and commercial interiors. From the classic kitchen soffit above upper cabinets to sophisticated multi-level ceiling details in commercial lobbies, our work is precise, clean-lined, and beautifully finished.",
  ...
  imageAlt: "Custom bulkhead ceiling installation in a residential interior in Saskatoon, SK by Dil Chahal Constructions",
  serviceJsonLd,
  faqJsonLd,
  breadcrumbJsonLd,
  webPageJsonLd,
