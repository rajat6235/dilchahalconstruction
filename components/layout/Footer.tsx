    ...
    <footer style={{ backgroundColor: "#000000", color: "#ffffff" }}>
      ...
      <div className="bg-[#0d0d0d] border-t border-white/5 py-3 px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-center gap-2 flex-wrap">
          <span className="text-[#555] text-xs tracking-wide">Designed &amp; Developed by</span>
          <span className="text-[#888] text-xs font-medium tracking-wide">Rajat</span>
          <span className="text-[#333] text-xs">·</span>
          <div className="flex items-center gap-2">
            <a href="https://www.linkedin.com/in/rajat6235" target="_blank" rel="noopener noreferrer" aria-label="Rajat on LinkedIn" className="group flex items-center gap-1.5 text-[#555] hover:text-[#0A66C2] transition-colors duration-300">
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
              <span className="text-xs group-hover:text-[#0A66C2] transition-colors duration-300">LinkedIn</span>
            </a>
            <span className="text-[#333] text-xs">·</span>
            <a href="https://github.com/rajat6235" target="_blank" rel="noopener noreferrer" aria-label="Rajat on GitHub" className="group flex items-center gap-1.5 text-[#555] hover:text-white transition-colors duration-300">
            ...
            <span className="text-[#333] text-xs">·</span>
            <a href="https://wa.me/917837733549" target="_blank" rel="noopener noreferrer" aria-label="Rajat on WhatsApp" className="group flex items-center gap-1.5 text-[#555] hover:text-[#25D366] transition-colors duration-300">
