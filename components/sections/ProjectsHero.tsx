...
export default function ProjectsHero() {
  ...
  return (
    ...
    <section className="relative w-full overflow-x-hidden" style={{ minHeight: "466px" }}>
      ...
      {/* Dark overlay — matches WP darkness */}
      ...
      <header className="relative z-20 w-full">
        ...
        <div className="w-full flex items-center justify-between py-3 px-4 md:py-4 md:px-[40px]" style={{ minHeight: "clamp(100px, 20vw, 198px)" }}>
          ...
          <p className="hidden md:block" style={{ color: "#E00201", fontFamily: "var(--font-body)", fontSize: "15px", fontWeight: 400 }}>
            Make a call:{" "}
            <a href="tel:+13067171994" style={{ color: "inherit", textDecoration: "none" }}>
              +1 (306) 717-1994
            </a>
          </p>
          ...
          <div className="hidden md:flex items-center flex-1" style={{ paddingLeft: "40px" }}>
            {navLinks.map((link) => (
              <Link
                ...
                style={{ fontFamily: "var(--font-body)", fontSize: "15px", fontWeight: 500, padding: "0px 15px" }}
              >
                {link.label}
              </Link>
            ))}
        ...
        {/* Mobile dropdown */}
        {menuOpen && (
          <div id="projects-mobile-nav" className="md:hidden w-full" style={{ background: "rgba(0,0,0,0.92)", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
            {navLinks.map((link) => (
              <Link
                key={link.label}
                href={link.href}
